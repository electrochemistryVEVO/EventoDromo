// src/app/user-login/carrito/entradaDetalle/page.jsx
"use client";
import styles from "@/css/entradaDetalle.module.css";

// 1. ¡CORRECCIÓN! Importa el CONTROLADOR, no la vista.
import { TablaEntradasController } from "@/components/carrito/TablaEntradas.controller"; 
// 2. Importa el CONTROLADOR de costos (basado en tu refactor anterior)
    ...
    <div className={styles.pageContainer}>
      ...
      <section className="flex flex-col gap-8 lg:flex-row lg:gap-20">
        <div className="w-full lg:w-2/3">
          ...
          {/* 3. ¡CORRECCIÓN! Renderiza el CONTROLADOR */}
        ...
        >
          ...
          {/* 4. ¡CORRECCIÓN! Renderiza el CONTROLADOR */}
          ...
          <div className="flex flex-col items-center gap-5 mt-10">
            ...
            <button
              ...
              onClick={() => {
                if (aceptaTerminos) {
                  router.push("/user-login/carrito/identificacion");
                }
              }}
            >
            ...
            <button
              onClick={() => router.push("/user-login/web/eventos/lista")}
              className="w-full flex flex-row justify-center items-center gap-4 max-w-sm rounded-2xl bg-[#EFECEC] py-4 text-base font-bold text-gray-500 transition border-gray-400 border-2"
            >
