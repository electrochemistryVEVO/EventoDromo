  ...
  <div className="flex flex-col gap-4 ml-7">
    ...
    <div className="flex gap-4">
      <div className={`w-full ${styles.formField}`}>
        <label htmlFor="cardExpiryMonth" className={styles.formLabel}>
          Vencimiento
        </label>
      ...
      <div className={`w-1/2 ${styles.formField}`}>
        <label htmlFor="cardCVV" className={styles.formLabel}>
          CVV
        </label>
        <input
          id="cardCVV"
              ...
              {selectedPaymentMethod === "tarjeta" && (
                <div className="flex flex-col items-center gap-1 w-full">
                  ...
                  <div className="flex items-center">
                    <span className="text-2xl text-[#00C49A]">&#36;</span>
                    <span className="font-bold text-base text-[#00C49A] ml-1">
                      +12 Dromopuntos
                    </span>
                  </div>
                </div>
