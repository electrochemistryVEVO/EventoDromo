...
export default function UserLoginCambiarContrasenaLayoutClient({ children }) {
  ...
  useEffect(() => {
    ...
    const checkAccess = () => {
      ...
      console.log("Verificando rol de usuario en /user-login/cambiarcontrasena:", userRole);
