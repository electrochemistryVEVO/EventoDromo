...
const CSVUploadErrorModal = ({ isOpen, onClose, errors, failedCount = 0 }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-xl mx-4 relative">
        ...
        <div className="p-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800 text-center mb-2">
            Carga fallida . <strong>{failedCount} Locales</strong> no han podido ser cargados.
          </h2>
...
export default CSVUploadErrorModal;
