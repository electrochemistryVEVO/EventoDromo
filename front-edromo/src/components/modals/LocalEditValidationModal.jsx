...
const LocalEditValidationModal = ({ isOpen, onClose, errors, localName }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-xl mx-4 relative">
        ...
        <div className="p-6">
          <h2 className="text-2xl font-bold text-red-600 mb-4">
            No se puede modificar este local
          </h2>
          
          <p className="text-gray-700 mb-6">
            El local <strong>{localName}</strong> no puede ser modificado por que tiene{' '}
...
LocalEditValidationModal.propTypes = {
...
export default LocalEditValidationModal;
