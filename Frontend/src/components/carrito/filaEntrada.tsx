...
export const FilaEntrada: React.FC<CartRowProps> = ({ item, selected, onToggle, onRemove }) => {
    return (
        <li
            className="grid grid-cols-[auto_1fr_128px_160px_auto] items-center gap-x-4 px-4 py-4 transition-colors hover:bg-slate-50"
        >
            {/* Checkbox */}
            <div>
                <input
            ...
            <div className="flex w-16 justify-center">
                <button onClick={() => onRemove(item.id)} className="text-gray-400 hover:text-red-500 transition-colors" aria-label={`Eliminar ${item.title}`}>
